    ...
    <div className="relative flex min-h-dvh items-center justify-center p-4">
      ...
      <GlassPanel strong className="w-full max-w-md p-8 shadow-xl">
        <div className="mb-8 flex flex-col items-center text-center">
          <motion.div
            className="mb-4 flex h-14 w-14 items-center justify-center rounded-[30px] bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-md shadow-blue-500/20"
        ...
        <div className="mb-6 flex rounded-[30px] border border-blue-100/50 bg-blue-50/40 p-1">
          <button
            type="button"
            onClick={() => setAuthMode('login')}
            className={`flex-1 rounded-[30px] py-2.5 text-sm font-semibold transition-all duration-300 ${
              isLogin
                ? 'bg-white text-blue-600 shadow-sm border border-blue-100/20'
