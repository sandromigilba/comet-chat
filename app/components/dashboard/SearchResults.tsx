      ...
      {searchResults.map((username) => (
        <li key={username}>
          <button
            ...
            className="flex w-full items-center gap-3 rounded-[30px] px-3.5 py-2.5 text-left transition-all duration-300 hover:bg-brand-light/15"
          >
            ...
            <span className="text-sm font-medium text-slate-750 hover:text-black transition-colors duration-200">
              {username}
            </span>
