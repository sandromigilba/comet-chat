  ...
  return (
    <>
      <button
        type="button"
        onClick={onOpen}
        className="fixed left-4 top-4 z-30 rounded-[30px] glass hover:bg-white border border-brand-light/30 p-2.5 lg:hidden shadow-sm transition-colors duration-200"
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-[min(100%,320px)] flex-col border-r border-brand-light/25 glass transition-transform duration-300 lg:static lg:z-0 lg:translate-x-0 ${
        ...
        <div className="p-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-[30px] border border-brand-light/40 bg-slate-50/80 py-2.5 pl-11 pr-4 text-sm text-slate-800 placeholder:text-slate-400 focus:border-brand-medium focus:bg-white focus:outline-none focus:ring-4 focus:ring-brand-light/20 transition-all duration-200 shadow-inner"
            />
          </div>
        </div>
                  ...
                  <li key={username}>
                    <button
                      ...
                      className={`flex w-full items-center gap-3 rounded-[30px] px-3.5 py-2.5 text-left transition-all duration-300 ${
                        activePeer === username
                          ? 'bg-brand-medium/15 text-brand-dark border border-brand-light/20'
                          : 'text-slate-600 hover:bg-brand-light/15 hover:text-brand-deep'
                      }`}
                    >
